...
<html lang="fr">
	...
	<body>
		...
		<div class="borders">
          ...
          <div  class="row" class="border">
            <div  class="col-md-1" style="background-color:#D6D3D3; border-radius: 0px">1</div>
            <div  class="col-md-2 yellow" style="border-radius: 0px">2</div>
            <div  class="col-md-3" style="background-color:#E8B623;border-radius: 0px">3</div>
            <div  class="col-md-6" style="background-color:#F2ECE7;border-radius: 0px">6</div>
          </div>
        	<div  class="row" >
          	<div  class="col-md" style="background-color:#E87D23;border-radius: 0px" >12</div>
        	</div>
	        <div  class="row">
	          <div class="col-md-4" style="background-color:#F2ECE7;border-radius: 0px">4</div>
	          <div class="col-md-8" style="background-color:#B5B3B1;border-radius: 0px">8</div>
	        </div>
	        <div  class="row">
	          <div class="col-md-1" style="background-color:#F2ECE7;border-radius: 0px"></div>
	          <div class="col-md-1" style="background-color:#F2ECE7;border-radius: 0px"></div>
	          <div class="col-md-1" style="background-color:#F2ECE7;border-radius: 0px"></div>
	          <div class="col-md-1" style="background-color:#F2ECE7;border-radius: 0px"></div>
	          <div class="col-md-1" style="background-color:#F2ECE7;border-radius: 0px"></div>
		...
		<div class="borders">
			...
			<div class="votreReponse">
				<p>Champ de réponse</p>
        <header  class="row" >
          <div  class="col-md col-sm-6" style="background-color:#F2ECE7;border-radius: 0px" >	HEADER</div>
        </header>
				<div class="row">
  				<div class="col-md-1 col-sm-6 yellow" style="border-radius: 0px"></div>
  				<div class="col-md-6 col-sm-6 offset-sm-1  green"style="border-radius: 0px"></div>
  				<div class="col-md-2 col-sm-6 offset-sm-2"style="background-color:#E87D23;border-radius: 0px"></div>
				</div>
				<footer  class="row">
          <div  class="col-md col-sm-6" style="background-color:#F2ECE7;border-radius: 0px">FOOTER</div>
        </footer>
        <div  class="row">
            <div class="col-md-1" style="background-color:#F2ECE7;border-radius: 0px"></div>
            <div class="col-md-1" style="background-color:#F2ECE7;border-radius: 0px"></div>
		...
		<div class="borders">
			...
			<div class="votreReponse">
      		...
      		<div class="row col-md-9">
						<div class="col-md-1 offset-md-1">1</div>
            <div>&nbsp;</div>
						<div class="col-md-1">2</div>
						<div class="col-md-1">3</div>
            <div>&nbsp;</div>

						<div class="col-md-5 offset-md-6">3</div>
					</div>
  	     </div>
      </div>
    </div>
    <div></div>
        ...
        <div class="container">
          <header class="row">
            <div class="col-sm-12 col-xs-12" style="background-color:#B5B3B1;border-radius: 0px">HEADER</div>
          </header>
            <div class="row">
              <nav class="col-sm-2 col-xs-2" style="background-color:#E87D23;border-radius: 0px">MENU</nav>
              <section class="col-sm-10 col-xs-10 " style="background-color:#E8B623;border-radius: 0px">SECTION
                <div class="row">
                  <article class="col-sm-10 col-xs-10  yellow" style="border-radius: 0px">ARTICLE</article>
                  <aside class="col-sm-2 col-xs-2 " style="background-color:#F2ECE7;border-radius: 0px">ASIDE</aside>
                  <article class="col-md-10 col-xs-10 yellow" style="border-radius: 0px"></article>
                  <aside class="col-sm-2 col-xs-2 " style="background-color:#F2ECE7;border-radius: 0px">ASIDE</aside>
                </div>
              </section>
            </div>
          <footer class="row">
            <div class="col-sm-12 col-xs-12 " style="background-color:#B5B3B1;border-radius: 0px">FOOTER</div>
          </footer>
        </div>
      </div>
    </div>
		...
		<div class="borders">
          ...
          <div class="row col-lg">
            <div class="d-sm-none d-md-block">2</div>
          </div>
          <div class="row col-lg">
            <div class="d-xl-none d-lg-block">3</div>
          </div>
          <div class="row col-lg">
            <div class="d-none d-sm-block">4</div>
          </div>
          <div class="row col-lg">
            <div class="d-sm-none d-block">5</div>
          </div>
			</div>
		</div>
